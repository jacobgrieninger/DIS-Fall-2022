...
router.post('/', [
    ...
    check('tuesdayClose', 'Tuesday Close availability required').not().isEmpty(),
    check('wednesdayOpen', 'Wednesday Open availability required').not().isEmpty(),
    check('wednesdayClose', 'Wednesday Close availability required').not().isEmpty(),
    check('thursdayOpen', 'Thursday Open availability required').not().isEmpty(),
    check('thursdayClose', 'Thursday Close availability required').not().isEmpty(),
    ...
    check('saturdayOpen', 'Saturday Open availability required').not().isEmpty(),
    check('saturdayClose', 'Saturday Close availability required').not().isEmpty()
],
async (req, res) => {
